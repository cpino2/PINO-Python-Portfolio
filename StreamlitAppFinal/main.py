...
st.write("Click on the box below to select whether or not you carry the APOE4 Gene.")#caption to prompt the user to select whether or not they carry APOE4 gene
