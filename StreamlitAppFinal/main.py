...
expander = st.expander("Click here to learn more about how the predictive model works using Random Forest Classifier:")
expander.write('''
...
st.write("Click on the box below to select whether or not you carry the APOE4 Gene. Research has found that the presence of this gene influences the likelihood of Alzheimer's disease onset.")#caption to prompt the user to select whether or not they carry APOE4 gene
