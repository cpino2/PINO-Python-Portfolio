...
Looking back on this semester, I am proud of my repository development! I kept my projects organized and am now easily able to share my projects with anyone. I am excited to share my disease predictor app with others in the healthcare domain! I look forward to creating more projects to add to my repository in the future, particularly with a focus in healthcare as it relates to that which I am passionate about. Some ideas I have for future projects include exploratory data analyses with large patient datasets, data visualizations for healthcare data collected through the National Institue of Health, and more app creations such as disease predictors for other conditions! I also hope to somehow incorporate exercise and sports with healthcare for the next app I create. In particluar, I am a member of a Sports Biomechanics Research Group here at the University of Notre Dame, and one of our goals for next semester includes creating an app that Notre Dame Athletes can use to get feedback from the research we are conducting on their movement mechanics as well as the influence neuroscientifc factors have on their performance and risk of injury! I look forward to applying all the skills which I learned this semester to my role as a member of the research team next semester, and I will be sure to deploy the app to the Streamlit Community Cloud once it is created so that others can explore my work and gather ideas just as I have done! 
